 ...
 * com a funçao doInput() e enviar pro eventdispatcher que sua vez envia para todos os outros
 * handlers.
 * Na pratica basta  chamar doInput(); no mainloop da engine
 * TODO existe a necessidade de criar factory pra isso para suportar outras implementaçoes
