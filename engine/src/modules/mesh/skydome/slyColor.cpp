...
float SkyColor::perezFunction_x(float cosTheta, float cosGamma, float gamma){	
...
float SkyColor::perezFunction_y(float cosTheta, float cosGamma, float gamma){	
...
void SkyColor::toRGBA(float x, float y, float Y, vec4* rgb){
